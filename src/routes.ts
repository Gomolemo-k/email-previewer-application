...
export enum Routes {
  ...
  // dashboard routes
  Dashboard = '/dashboard',
  DashboardEmailPreviewComponents = '/dashboard/preview-email/components',
  DashboardEmailPreviewDashboard = '/dashboard/preview-email/dashboard',
  DashboardEmailPreviewPreview = '/dashboard/preview-email/preview',
  DashboardEmailPreviewServices = '/dashboard/preview-email/services', 
