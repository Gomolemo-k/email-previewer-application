...
import { easeInOut, easeOut } from 'motion'; // ✅ easing functions
...
const animations = {
  pulse: {
    ...
    transition: { duration: 1.2, ease: easeInOut }, // ✅ fixed
  },
  glow: {
  ...
  particle: (index: number) => ({
    ...
    transition: { duration: 0.8, delay: index * 0.05, ease: easeOut }, // ✅ fixed
  }),
};
